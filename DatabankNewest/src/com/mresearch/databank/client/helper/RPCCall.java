...
import com.mresearch.databank.client.event.RPCInEvent;
import com.mresearch.databank.client.event.RPCOutEvent;
import com.mresearch.databank.shared.exception.NotLoggedInException;
...
public abstract class RPCCall<T> implements AsyncCallback<T> {
  ...
  private void onRPCIn() {
    DatabankApp.get().getEventBus().fireEvent(new RPCInEvent());
  }
  private void onRPCOut() {
    DatabankApp.get().getEventBus().fireEvent(new RPCOutEvent());
  }
