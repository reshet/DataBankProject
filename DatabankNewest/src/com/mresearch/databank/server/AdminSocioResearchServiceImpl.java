...
public class AdminSocioResearchServiceImpl extends RemoteServiceServlet implements
	...
	public MetaUnitMultivaluedDTO getMetaUnitMultivaluedFullDTO(long id) {
		return eao.getMetaUnitMultivaluedFullDTO(id);
	}
	...
	public void addMetaUnit(MetaUnitDTO dto, Long parent_unit_id) {
		eao.addMetaUnit(parent_unit_id, dto);
	}


	@Override
	public void addEntityItem(Long entity_id, String value,
	...
	@Override
	public void deleteEntityItem(Long id) {
		eao.deleteEntityItem(id);
	}


	@Override
	public void editEntityItem(Long entity_id, String value,
			HashMap<String, String> filling) {
